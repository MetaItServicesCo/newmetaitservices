        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="team-card">
                        <div class="team-img bg-blue">
                            <img src="{{ asset('frontend/images/about/team-img1.png') }}" alt="" class="marg-left">
                        </div>
                ...
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="team-card">
                        <div class="team-img bg-purple">
                            <img src="{{ asset('frontend/images/about/rem-bg.png') }}" alt="" class="marg-right">
                        </div>
                ...
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="team-card">
                        <div class="team-img bg-yellow">
                            <img src="{{ asset('frontend/images/about/team-img3.png') }}" alt="" class="marg-right">
                        </div>
                ...
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="team-card">
                        <div class="team-img bg-blue">
                            <img src="{{ asset('frontend/images/about/team-img4.png') }}" alt="" class="marg-righ">
                        </div>
                ...
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="team-card">
                        <div class="team-img bg-purple">
                            <img src="{{ asset('frontend/images/about/rem-bg2.png') }}" alt="" class="marg-left">
                        </div>
