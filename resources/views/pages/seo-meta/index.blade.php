            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-kt-user-table-filter="search"
                        ...
                        id="metaSearchInput" />
                    <button type="button" class="btn btn-sm btn-icon position-absolute end-0 me-2 d-none" id="metaSearchClear">
                        {!! getIcon('cross', 'fs-3') !!}
                    </button>
                </div>
                <!--end::Search-->
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                searchInput.addEventListener('keyup', function() {
                    window.LaravelDataTables['seo-meta-table'].search(this.value).draw();
                ...
                clearBtn.addEventListener('click', function() {
                    searchInput.value = '';
                    window.LaravelDataTables['seo-meta-table'].search('').draw();
